...
Welcome to Renewed Weapons Script, this script allows user to define Player slots when it comes to weapons / items on the players back along with a few other features such as.

## Please see [Renewed-Carryitems](https://github.com/Renewed-Scripts/Renewed-Carryitems)
...
4. `exports["Renewed-Weaponscarry"]:isCarryingAnObject(item)` - Returns true if the players is carrying a specific item
