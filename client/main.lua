...
--[[
    ...
    This means that instead of giving each weapon a designated slot on the back, we can just add a weapon with the
    designated slot
...
--[[
    This is props here we are defining the props that we want to use when an item is in the player's inventory.
]]--
local props = {
    ---- ** Drugs ** ----
    -- Weed
